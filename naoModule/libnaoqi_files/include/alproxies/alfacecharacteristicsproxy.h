// Generated for ALFaceCharacteristics version 0

#ifndef ALFACECHARACTERISTICSPROXY_H_
#define ALFACECHARACTERISTICSPROXY_H_
...
namespace AL
{
  class ALBroker;
  class ALProxy;
  class ALFaceCharacteristicsProxy;

  namespace detail {
    class ALFaceCharacteristicsProxyPostHandler
    {
    protected:
      ALFaceCharacteristicsProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALFaceCharacteristicsProxy;
      ...
      /// </summary>
      /// <param name="threshold"> New threshold (must be between 0.0 and 1.0. </param>
      /// <returns> brokerTaskID : The ID of the task assigned to it by the broker.</returns>
      int setSmilingThreshold(const float& threshold);
  ...
  /// <summary></summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALFaceCharacteristicsProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALFaceCharacteristicsProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALFaceCharacteristicsProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALFaceCharacteristicsProxy(const std::string &ip, int port=9559);
    ...
    bool analyzeFaceCharacteristics(const int& id);
    ...
    /// </summary>
    /// <param name="threshold"> New threshold (must be between 0.0 and 1.0. </param>
    void setSmilingThreshold(const float& threshold);
    ...
    detail::ALFaceCharacteristicsProxyPostHandler post;
  };

}
#endif // ALFACECHARACTERISTICSPROXY_H_
