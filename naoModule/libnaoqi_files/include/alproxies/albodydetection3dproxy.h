// Generated for ALBodyDetection3D version 1.18

#ifndef ALBODYDETECTION3DPROXY_H_
#define ALBODYDETECTION3DPROXY_H_
...
namespace AL
{
  class ALBroker;
  class ALProxy;
  class ALBodyDetection3DProxy;

  namespace detail {
    class ALBodyDetection3DProxyPostHandler
    {
    protected:
      ALBodyDetection3DProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALBodyDetection3DProxy;
  ...
  /// \ingroup ALProxies
  class ALPROXIES_API ALBodyDetection3DProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALBodyDetection3DProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALBodyDetection3DProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALBodyDetection3DProxy(const std::string &ip, int port=9559);
    ...
    detail::ALBodyDetection3DProxyPostHandler post;

  };

}
#endif // ALBODYDETECTION3DPROXY_H_
