// Generated for ALHeadPoseAnalysis version 1.17

#ifndef ALHEADPOSEANALYSISPROXY_H_
#define ALHEADPOSEANALYSISPROXY_H_
...
namespace AL
{
  class ALBroker;
  class ALProxy;
  class ALHeadPoseAnalysisProxy;

  namespace detail {
    class ALHeadPoseAnalysisProxyPostHandler
    {
    protected:
      ALHeadPoseAnalysisProxyPostHandler(boost::shared_ptr<ALProxy> proxy);

    public:
      friend class AL::ALHeadPoseAnalysisProxy;
  ...
  /// <summary>This module computes the head pose of a personfrom the analysis of the image of his/her face</summary>
  /// \ingroup ALProxies
  class ALPROXIES_API ALHeadPoseAnalysisProxy
  {
  private:
    boost::shared_ptr<ALProxy> _proxy;
  ...
  public:
    ...
    ALHeadPoseAnalysisProxy(boost::shared_ptr<ALBroker> broker);

    /// <summary>
    /// Explicit Proxy Constructor. Create a specialised proxy from a generic proxy.
    /// </summary>
    /// <param name="broker">A smart pointer to your broker</param>
    ALHeadPoseAnalysisProxy(boost::shared_ptr<ALProxy> proxy);
    ...
    ALHeadPoseAnalysisProxy(const std::string &ip, int port=9559);
    ...
    detail::ALHeadPoseAnalysisProxyPostHandler post;

  };

}
#endif // ALHEADPOSEANALYSISPROXY_H_
